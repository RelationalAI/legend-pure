...
public class TestDSLCompilation extends AbstractPureTestWithCoreCompiled
{
    ...
    public void testSimple() throws Exception
    {
        ...
        {
            Assert.assertEquals("Compilation error at (resource:file.pure line:4 column:13), \"Type argument mismatch for the class Firm<T> (expected 1, got 0): Firm\"", e.getMessage());
        }
