...
/**
 * Paths for standard M2 Mapping model elements
 */
public class M2MappingPaths
{
    private M2MappingPaths()
    {
    }
    ...
    public static final String InstanceSetImplementation = "meta::pure::mapping::InstanceSetImplementation";
    public static final String Mapping = "meta::pure::mapping::Mapping";
    public static final String MappingClass = "meta::pure::mapping::MappingClass";
    public static final String MappingInclude = "meta::pure::mapping::MappingInclude";
    public static final String OperationSetImplementation = "meta::pure::mapping::OperationSetImplementation";
    public static final String OtherwiseEmbeddedSetImplementation = "meta::pure::mapping::OtherwiseEmbeddedSetImplementation";
    public static final String PropertyMapping = "meta::pure::mapping::PropertyMapping";
