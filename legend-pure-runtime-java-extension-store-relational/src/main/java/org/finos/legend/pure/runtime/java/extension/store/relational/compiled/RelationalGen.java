...
import org.finos.legend.pure.generated.Root_meta_external_store_relational_metamodel_SQLNull_Impl;
import org.finos.legend.pure.generated.Root_meta_external_store_relational_metamodel_execute_ResultSet_Impl;
import org.finos.legend.pure.generated.Root_meta_external_store_relational_metamodel_execute_Row_Impl;
import org.finos.legend.pure.generated.Root_meta_external_store_relational_runtime_DataSource_Impl;
...
public class RelationalGen
{
    ...
    {
        return RelationalNativeImplementation.executeInDb(sql, pureConnection, queryTimeoutInSeconds, fetchSize, si, () -> new Root_meta_external_store_relational_metamodel_execute_ResultSet_Impl("OK"), () -> new Root_meta_external_store_relational_metamodel_SQLNull_Impl("SQLNull"), () -> new Root_meta_external_store_relational_metamodel_execute_Row_Impl("ID"), () -> new Root_meta_external_store_relational_runtime_DataSource_Impl("ID"), es);
    }
    ...
    {
        return RelationalNativeImplementation.createTempTable(tableName, sql, pureConnection, queryTimeoutInSeconds, fetchSize, si, relyOnFinallyForCleanup, () -> new Root_meta_external_store_relational_metamodel_execute_ResultSet_Impl("OK"), () -> new Root_meta_external_store_relational_metamodel_SQLNull_Impl("SQLNull"), () -> new Root_meta_external_store_relational_metamodel_execute_Row_Impl("ID"), () -> new Root_meta_external_store_relational_runtime_DataSource_Impl("ID"), es);
    }
    ...
    {
        return RelationalNativeImplementation.fetchDbMetaData(pureConnection, sqlFunction, extraValues, () -> new Root_meta_external_store_relational_metamodel_execute_ResultSet_Impl("OK"), () -> new Root_meta_external_store_relational_metamodel_SQLNull_Impl("SQLNull"), () -> new Root_meta_external_store_relational_metamodel_execute_Row_Impl("ID"), () -> new Root_meta_external_store_relational_runtime_DataSource_Impl("ID"), es);
    }
}
