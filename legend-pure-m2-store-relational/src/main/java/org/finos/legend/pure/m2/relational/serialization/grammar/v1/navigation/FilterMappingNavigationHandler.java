...
public class FilterMappingNavigationHandler implements NavigationHandler<FilterMapping>
{
    @Override
    ...
    @Override
    public CoreInstance findNavigationElement(FilterMapping instance, String sourceCode, int line, int column, ProcessorSupport processorSupport)
    {
