...
public class RelationalGraphBuilderTest
{
    ...
    public void testDefaultJoin()
    {
        ...
        Assert.assertEquals(
                "^meta::external::store::relational::metamodel::join::Join Firm_Person_In0?[sourceId:1,1,1,1,1,1]?(name='Firm_Person_In0', operation=^meta::external::store::relational::metamodel::DynaFunction(name = 'and', parameters = [^meta::external::store::relational::metamodel::DynaFunction(name = 'equal', parameters=[^meta::external::store::relational::metamodel::TableAliasColumn?[sourceId:1,1,1,1,1,1]?(columnName='ID',alias=^meta::external::store::relational::metamodel::TableAlias?[sourceId:1,1,1,1,1,1]?(name = 'firmTable')),^meta::external::store::relational::metamodel::TableAliasColumn?[sourceId:1,1,1,1,1,1]?(columnName='FIRMID',alias=^meta::external::store::relational::metamodel::TableAlias?[sourceId:1,1,1,1,1,1]?(name = 'personTable'))]), ^meta::external::store::relational::metamodel::DynaFunction(name = 'group', parameters = ^meta::external::store::relational::metamodel::DynaFunction(name = 'or', parameters = [^meta::external::store::relational::metamodel::DynaFunction(name = 'equal', parameters=[^meta::external::store::relational::metamodel::TableAliasColumn?[sourceId:1,1,1,1,1,1]?(columnName='ID',alias=^meta::external::store::relational::metamodel::TableAlias?[sourceId:1,1,1,1,1,1]?(name = 'firmTable')),^meta::external::store::relational::metamodel::Literal(value=1)]), ^meta::external::store::relational::metamodel::DynaFunction(name = 'equal', parameters=[^meta::external::store::relational::metamodel::TableAliasColumn?[sourceId:1,1,1,1,1,1]?(columnName='ID',alias=^meta::external::store::relational::metamodel::TableAlias?[sourceId:1,1,1,1,1,1]?(name = 'firmTable')),^meta::external::store::relational::metamodel::Literal(value=2)]), ^meta::external::store::relational::metamodel::DynaFunction(name = 'equal', parameters=[^meta::external::store::relational::metamodel::TableAliasColumn?[sourceId:1,1,1,1,1,1]?(columnName='ID',alias=^meta::external::store::relational::metamodel::TableAlias?[sourceId:1,1,1,1,1,1]?(name = 'firmTable')),^meta::external::store::relational::metamodel::Literal(value=3)])]))]))",
                joinResult
        );
    }
    ...
    public void testJoinWithPrefixInClauseAndStrings()
    {
        ...
        Assert.assertEquals(
                "^meta::external::store::relational::metamodel::join::Join Firm_Person_In2_Prefix?[sourceId:1,1,1,1,1,1]?(name='Firm_Person_In2_Prefix', operation=^meta::external::store::relational::metamodel::DynaFunction(name = 'and', parameters = [^meta::external::store::relational::metamodel::DynaFunction(name = 'equal', parameters=[^meta::external::store::relational::metamodel::TableAliasColumn?[sourceId:1,1,1,1,1,1]?(columnName='ID',alias=^meta::external::store::relational::metamodel::TableAlias?[sourceId:1,1,1,1,1,1]?(name = 'firmTable')),^meta::external::store::relational::metamodel::TableAliasColumn?[sourceId:1,1,1,1,1,1]?(columnName='FIRMID',alias=^meta::external::store::relational::metamodel::TableAlias?[sourceId:1,1,1,1,1,1]?(name = 'personTable'))]), ^meta::external::store::relational::metamodel::DynaFunction(name = 'in', parameters=[^meta::external::store::relational::metamodel::TableAliasColumn?[sourceId:1,1,1,1,1,1]?(columnName='LEGALNAME',alias=^meta::external::store::relational::metamodel::TableAlias?[sourceId:1,1,1,1,1,1]?(name = 'firmTable')),^meta::external::store::relational::metamodel::LiteralList(values=[^meta::external::store::relational::metamodel::Literal(value='Google'),^meta::external::store::relational::metamodel::Literal(value='Apple')])])]))",
                joinResult
        );
    }
